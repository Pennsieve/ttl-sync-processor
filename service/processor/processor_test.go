...
func TestCurationExportSyncProcessor_Run(t *testing.T) {
	...
	assert.Len(t, changeset.Models.Updates, 3)

	// Contributors
	contributorChanges := findModelUpdateByID(t, changeset.Models, "d77470bb-f39d-49ee-aa17-783e128cdfa0")
	...
	// Subjects
	subjectChanges := findModelUpdateByID(t, changeset.Models, "44fe1f90-f7b5-407a-8689-c512d7f41b7d")
	...
	// Samples
	sampleChanges := findModelUpdateByID(t, changeset.Models, "29756423-00de-42f8-8706-acdcb1823685")
...
func findModelUpdateByID(t *testing.T, modelChanges changesetmodels.ModelChanges, modelID string) changesetmodels.ModelUpdate {
	index := slices.IndexFunc(modelChanges.Updates, func(changes changesetmodels.ModelUpdate) bool {
		return changes.ID.String() == modelID
	})
	require.GreaterOrEqual(t, index, 0)
	return modelChanges.Updates[index]
}
