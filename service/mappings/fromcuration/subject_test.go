...
func TestToSubject(t *testing.T) {
	...
	subject3 := exported[2]
	metadatatest.AssertExternalInstanceIDEqual(t, "9b942959-2ebb-4680-b3f7-6d1cdbbe706d", subject3.ID)
	assert.Equal(t, "Canis familiaris", subject3.Species)
	assert.Empty(t, subject3.SpeciesSynonyms)

	subject4 := exported[3]
	metadatatest.AssertExternalInstanceIDEqual(t, "5061b8e3-086b-4e87-b2f0-08f1a5b96679", subject4.ID)
